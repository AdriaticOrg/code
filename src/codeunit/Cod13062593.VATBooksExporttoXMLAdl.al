codeunit 13062593 "VAT Books Export to XML-Adl"
{
    ...
    var
        ...
        PPPDVTagLbl: Label 'PPPDV',Locked= true;
        ComTxtLbl: Label '<!-- %1 -->',Locked= true;
        ...
        TaxAdviserIDTagLbl: Label 'JMBGPoreskiSavetnik',Locked= true;
        ...
        SignaturesTagLbl: Label 'signatures',Locked= true;
        EnvelopaLbl: Label 'envelopa',Locked= true;
        AttachmentTabLbl: Label 'prilozi',Locked= true;
        ...
        ApplyTimeAttrLbl: Label '"vremePodnosenja=""%1"""',Locked= true;
