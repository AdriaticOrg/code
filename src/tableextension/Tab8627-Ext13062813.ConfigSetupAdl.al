tableextension 13062813 "Config. Setup-Adl" extends "Config. Setup" //8627
{
    fields
    {
        field(13062813; "ADL Enabled-Adl"; Boolean)
        {
            Caption = 'ADL Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062814; "VAT Enabled-Adl"; Boolean)
        {
            Caption = 'VAT Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062815; "Rep HR Enabled-Adl"; Boolean)
        {
            Caption = 'Rep HR Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062816; "Rep RS Enabled-Adl"; Boolean)
        {
            Caption = 'Rep RS Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062817; "Rep SI Enabled-Adl"; Boolean)
        {
            Caption = 'Rep SI Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062818; "FAS Enabled-Adl"; Boolean)
        {
            Caption = 'FAS Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062819; "KRD Enabled-Adl"; Boolean)
        {
            Caption = 'KRD Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062820; "BST Enabled-Adl"; Boolean)
        {
            Caption = 'BST Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062821; "VIES Enabled-Adl"; Boolean)
        {
            Caption = 'VIES Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062822; "Unpaid Receivables Enabled-Adl"; Boolean)
        {
            Caption = 'Unpaid Receivables Enabled';
            DataClassification = SystemMetadata;
        }
        field(13062823; "EU Customs-Adl"; Boolean)
        {
            Caption = 'EU Customs';
            DataClassification = SystemMetadata;
        }
