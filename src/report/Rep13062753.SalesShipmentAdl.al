report 13062753 "Sales - Shipment-Adl"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportlayout/Rep13062753.SalesShipmentAdl.rdlc';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SalesShptCopyText; StrSubstNo(DocNoLbl, CopyText))
                    {
                    }
    ...
    var
        ...
        DocNoLbl: Label 'Sales - Shipment %1', Comment = '%1 = Document No.';
    ...
    procedure BlanksForIndent(): Text
    begin
        exit(PadStr('', 2, ' '));
    end;
}
