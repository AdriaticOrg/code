report 13062682 "Export BST-Adl"
{
    ...
    dataset
    {
        dataitem("BST Report Header"; "BST Report Header-Adl")
        {
            ...
            dataitem("BST Code"; "BST Code-Adl")
            {
            ...
            area(Content)
            {
                group(General)
                {
                    field(HideZeros; HideZeros)
                    {
                        ...
                        ApplicationArea = All;
                        Visible = true;
                        ToolTip = 'Skips records wih zero values';
                    }
    ...
    var
        ...
        BSTReportLine: Record "BST Report Line-Adl";
        ExpFile: Boolean;
        IsTotaling: Boolean;
        IsBold: Boolean;
        HideZeros: Boolean;
    ...
    local procedure ExportBST(BSTRepHead: Record "BST Report Header-Adl")
    var
