report 13062662 "Export KRD-Adl"
{
    ...
    dataset
    {
        dataitem(KRDReportHeader; "KRD Report Header-Adl")
        {
    ...
    local procedure ExportKRD(KRDRepHead: Record "KRD Report Header-Adl")
    var
        CompanyInfo: Record "Company Information";
    ...
    begin
        ...
        XmlElem[7].Add(XmlText.Create(RespUser."Reporting Name-Adl"));

        XmlElem[7] := XmlElement.Create('Email', xbsrns);
        XmlElem[6].Add(xmlElem[7]);
        XmlElem[7].Add(XmlText.Create(RespUser."Reporting Email-Adl"));
        ...
        XmlElem[6].Add(xmlElem[7]);
        XmlElem[7].Add(XmlText.Create(RespUser."Reporting Position-Adl"));
        ...
        XmlElem[5].Add(xmlElem[6]);
        XmlElem[6].Add(XmlText.Create(RespUser."Reporting Name-Adl"));

        XmlElem[6] := XmlElement.Create('Email', xbsrns);
        XmlElem[5].Add(xmlElem[6]);
        XmlElem[6].Add(XmlText.Create(RespUser."Reporting Email-Adl"));
        ...
        if KRDReportLine.FindSet() then
            repeat
                ...
                case KRDReportLine."Claim/Liability" of
                    KRDReportLine."Claim/Liability"::Claim:
                        ClaimLiabStr := 'T';
                    KRDReportLine."Claim/Liability"::Liability:
                        ClaimLiabStr := 'O';
                end;
                ...
                XmlElem[6].Add(xmlElem[7]);
                XmlElem[7].Add(XmlText.Create(Format(KRDReportLine."Opening Balance", 0, PrecisionFormatTxt)));

                XmlElem[7] := XmlElement.Create('Increase', xbsrns);
                XmlElem[6].Add(xmlElem[7]);
                XmlElem[7].Add(XmlText.Create(Format(KRDReportLine."Increase Amount", 0, PrecisionFormatTxt)));

                XmlElem[7] := XmlElement.Create('Decrease', xbsrns);
                XmlElem[6].Add(xmlElem[7]);
                XmlElem[7].Add(XmlText.Create(Format(KRDReportLine."Decrease Amount", 0, PrecisionFormatTxt)));

                XmlElem[7] := XmlElement.Create('OtherChanges', xbsrns);
                XmlElem[6].Add(xmlElem[7]);
                XmlElem[7].Add(XmlText.Create(Format(KRDReportLine."Other Changes", 0, PrecisionFormatTxt)));

                XmlElem[7] := XmlElement.Create('ClosingBalance', xbsrns);
                XmlElem[6].Add(xmlElem[7]);
                XmlElem[7].Add(XmlText.Create(Format(KRDReportLine."Closing Balance", 0, PrecisionFormatTxt)));
