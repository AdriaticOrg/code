report 13062661 "Suggest KRD Lines-Adl"
{
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "Posting Date", "Document No.", "Customer No.", "KRD Non-Res. Sector Code-Adl";
        ...
        {
            RequestFilterFields = "Posting Date", "Document No.", "Vendor No.", "KRD Non-Res. Sector Code-Adl";
        ...
        case EntryType of
            EntryType::Customer:
                begin
                    ...
                    KRDRepLine.SetRange("Non-Resident Sector Code", cle."KRD Non-Res. Sector Code-Adl");
                    ...
                    if KRDRepLine.FindSet() then begin
                        ...
                        KRDRepLine."Non-Resident Sector Code" := cle."KRD Non-Res. Sector Code-Adl";
                        ...
                        cle."KRD Maturity-Adl", cle."KRD Claim/Liability-Adl", cle."KRD Non-Res. Sector Code-Adl", cle."KRD Country/Region Code-Adl",
            ...
            EntryType::Vendor:
                begin
                    ...
                    KRDRepLine.SetRange("Non-Resident Sector Code", VLE."KRD Non-Res. Sector Code-Adl");
                    ...
                    if KRDRepLine.FindSet() then begin
                        ...
                        KRDRepLine."Non-Resident Sector Code" := VLE."KRD Non-Res. Sector Code-Adl";
                        ...
                        VLE."KRD Maturity-Adl", VLE."KRD Claim/Liability-Adl", VLE."KRD Non-Res. Sector Code-Adl", VLE."KRD Country/Region Code-Adl",
    ...
    begin
        if InitialRep then begin
            ...
            OldCLE.SetRange("KRD Non-Res. Sector Code-Adl", NonResSecCode);
            ...
            OldVLE.SetRange("KRD Non-Res. Sector Code-Adl", NonResSecCode);
